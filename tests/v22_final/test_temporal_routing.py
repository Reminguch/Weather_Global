...
from src.models.mamba.v22_final.config import V22FinalArchitectureConfig  # noqa: E402
from src.models.mamba.v22_final.model import attach_temporal  # noqa: E402
...
def test_v22_defaults_to_one_bc_group() -> None:
    assert V22FinalArchitectureConfig(temporal_d_inner=4).temporal_bc_groups == 1
