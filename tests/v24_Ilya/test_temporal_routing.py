...
from src.models.mamba.v24_Ilya.config import V24IlyaArchitectureConfig  # noqa: E402
from src.models.mamba.v24_Ilya.model import attach_temporal  # noqa: E402
...
def test_v22_defaults_to_one_bc_group() -> None:
    assert V24IlyaArchitectureConfig(temporal_d_inner=4).temporal_bc_groups == 1
