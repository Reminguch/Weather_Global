"""v18 = baseline-stream residual (Exp 2-B, collapsed to single stream).
                ...
                for i in range(bptt):
                    ...
                    if i < bptt - 1:
                        ...
                        if next_i < ar_start_static:
                            ...
                            # AR zone: feed baseline_pred only (NOT corrected).
                            # This is the v17-A -> v18 fix: residual_inputs no
                            # longer carries corrected_pred, so input and
                            # target both live on GC-self-rollout trajectory.
