...
from graphcast_train.config import DEFAULT_CKPT, DEFAULT_DATA_PATH, DEFAULT_STATS_DIR, RunConfig
...
def parse_args() -> ResidualSegmentRunConfig:
    ...
    parser.add_argument("--baseline-ckpt", default=DEFAULT_CKPT)
