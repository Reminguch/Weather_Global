#!/usr/bin/env python3
"""Create a standalone anchor manifest for v24_Ilya."""
...
from src.models.mamba.v24_Ilya.anchor_manifest import build_anchor_manifest
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/graphcast/graphcast/dataset/anchor_manifests/v24_Ilya_res1"
        ),
    )
    ...
    parser.add_argument(
        "--compare-root",
        type=Path,
        help="Require generated anchor arrays to exactly match this manifest.",
    )
    ...
    metadata = build_anchor_manifest(
        ...
        reference_root=args.compare_root,
    )
    print(
