...
DRY_RUN=${DRY_RUN:-0}
TRAIN_SCRIPT="scripts/experiments/active/7y_mp6_gc_mamba_ds16_bptt16_res2_release_all20k.slurm"
EVAL_SCRIPT="scripts/analyze_models/submit_res2_ds16_gc_mamba_release_all20k_eval.sh"

TRAIN_CMD=(
  sbatch
  --parsable
  --job-name=7y-mp6-r2-ds16-release
  --mem=96G
  --time=12:00:00
  --array=0-8
  "${TRAIN_SCRIPT}"
