...
TRAIN_SCRIPT="scripts/experiments/active/7y_mp6_gc_mamba_ds16_k12_gclr3e7_mlr1e5_tdrop10_release20k.slurm"
EVAL_SCRIPT="scripts/analyze_models/submit_res2_ds16_gc_mamba_k12_gclr3e7_mlr1e5_tdrop10_release_eval.sh"

TRAIN_CMD=(
  sbatch
  --parsable
  --job-name=7y-mp6-r2-ds16-k12-g3e7-td10
  --mem=96G
  --time=07:00:00
  --array=0-1
  "${TRAIN_SCRIPT}"
