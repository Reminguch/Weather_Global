#!/usr/bin/env python3
"""Exactly merge independently evaluated v23_Ilya anchor shards."""
...
from src.models.mamba.v23_Ilya.evaluation import (  # noqa: E402
    write_evaluation_snapshot,
)
from src.models.mamba.v23_Ilya.metrics import (  # noqa: E402
...
def merge_v23_Ilya_eval_shards(
    *,
    ...
    merged: V23IlyaMetricAccumulator | None = None
    for shard_index in range(len(shard_payloads)):
        ...
        if merged is None:
            merged = V23IlyaMetricAccumulator.from_merge_state(state)
        else:
