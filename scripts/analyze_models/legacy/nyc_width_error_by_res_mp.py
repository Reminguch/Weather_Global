#!/usr/bin/env python3
"""Legacy NYC point-error metric extraction for one resolution + one mp.

Usage:
  python scripts/analyze_models/legacy/nyc_width_error_by_res_mp.py --res 4 --mp 1
"""
...
def main() -> None:
    ...
    print("  python scripts/analyze_models/legacy/plot_nyc_width_error_mae_vs_res.py")
