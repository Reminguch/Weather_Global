#!/usr/bin/env python
"""Regenerate the 2026-05-23-v22-style per-K plots for v22cl res=1 step 20000.

Same structure as regen_v22cl_r1_step14k_plots.py, just with step 20000.

Source: /home/lm8598/.../2026-6-29-v22cl-r1-step20k-eval/
        v22cl_r1_K{K}_step20000_{mode}_zero.json
"""
...
JSON_DIR = ROOT / "results/2026-6-29-v22cl-r1-step20k-eval"
...
def json_path(K, mode):
    return JSON_DIR / f"v22cl_r1_K{K}_step20000_{mode}_zero.json"
...
def make_overlay(mode):
    ...
    ax.set_title(f"v22cl r1 step20000 {mode} — paper-weighted MSE improvement")
...
def make_per_K(mode):
    ...
    for K in KSCAN:
        ...
        cmd = [str(PY), str(plot_script),
               str(jp), str(out_dir), f"v22cl_r1_step20k_{mode}", str(D_CONV)]
