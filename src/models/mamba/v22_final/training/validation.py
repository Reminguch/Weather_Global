"""Fixed-subset validation for the v22_final training objective."""
...
from .data import V22FinalTrainingData
...
def select_validation_segment_ids(
    training_data: V22FinalTrainingData, max_segments: int | None
...
def run_fixed_validation(
    *,
    ...
    residual_params,
    zero_residual_state,
    training_data: V22FinalTrainingData,
    task_config,
