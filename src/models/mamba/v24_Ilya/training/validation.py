"""Fixed-subset validation for the v24_Ilya training objective."""
...
from .data import V24IlyaTrainingData
...
def select_validation_segment_ids(
    training_data: V24IlyaTrainingData, max_segments: int | None
...
def run_fixed_validation(
    *,
    ...
    residual_params,
    zero_residual_state,
    training_data: V24IlyaTrainingData,
    task_config,
