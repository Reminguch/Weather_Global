"""Authoritative v24_Ilya model construction."""
...
from .config import V24IlyaArchitectureConfig, V24IlyaEvalConfig


def attach_temporal(
    predictor: gc.GraphCast,
    config: V24IlyaArchitectureConfig,
) -> gc.GraphCast:
    ...
    # v24_Ilya uses one full Mamba implementation for both persistence modes.
