...
Usage (from project root):
  python -m src.data_operations.loaders.inspect_graphcast_dataset [path]
  python -m src.data_operations.loaders.inspect_graphcast_dataset data/graphcast/graphcast/dataset/source-era5_wb13_latest-1y_res-1.0_levels-13_steps-all.zarr
  python -m src.data_operations.loaders.inspect_graphcast_dataset data/graphcast/graphcast/dataset/source-era5_cds_rolling-last30d_res-1.0_levels-13_steps-04.nc
"""
